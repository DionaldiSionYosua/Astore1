        ...
        <div class="profile-content">
            ...
            <div class="form-container">
                <form>
                    ...
                    <input type="text" value="aisyah_nurwa" readonly>

                    <label>Nama</label>
                    <input type="text" value="Aisyah Nurwa Hida" readonly>

                    <label>Email</label>
                    <input type="email" value="aisyah@example.com" readonly>
                    ...
                    <input type="text" value="02 Desember 2000" readonly>
                </form>
            </div>
        </div>
    </div>
